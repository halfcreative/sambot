...
module.exports = function dtimer(msg, splitMessage, isAdmin) {
    if (splitMessage[1]) {
        ...
        let LastCallTimeout = setTimeout(function () { msg.channel.send(`${msg.author}, your drop will come up in 15 minutes. Last call to grab a card.`); }, 1000);
        let Timeout = setTimeout(function () { msg.channel.send(`${msg.author}, your drop will come up in 10 minutes. Avoid grabbing anything unless necessary.`); clearTimers(); }, 1000);
