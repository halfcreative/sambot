...
export async function currentAttackCycle() {
...
export async function clanAttack() {
    const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
    let result;
    try {
        await client.connect();
...
export async function recordWork(userId, power) {
    const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
    let result;
    try {
        await client.connect();
...
export async function viewChurch() {
    const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
    let users = [];
    try {
        await client.connect();
...
export async function setUserCharacter(user, realmName, characterName) {
    console.log(user);
    const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
    await client.connect();
